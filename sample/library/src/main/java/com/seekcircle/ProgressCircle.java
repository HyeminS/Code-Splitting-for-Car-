...
public class ProgressCircle extends View {
    ...
    protected int mMaxProgress = 200;
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            // Read and clamp max
            int max = attributes.getInteger(R.styleable.SeekCircle_max, 200);
    ...
    private void updateDimensions(int width, int height) {
        ...
        mSectionRect.set(-sectionWidth / 4, -sectionHeight / 4, sectionWidth / 4, sectionHeight / 4);
